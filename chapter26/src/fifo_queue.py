...
if __name__ == "__main__":
    ...
    q = FifoQueue(r, "fifo-queue")

    assert q.enqueue("a") == 1, 'bad queue length after enqueueing "a"'
    assert q.enqueue("b") == 2, 'bad queue length after enqueueing "b"'
    assert q.enqueue("c") == 3, 'bad queue length after enqueueing "c"'
